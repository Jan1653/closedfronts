...
export class GameView implements GameMap {
  ...
  public update(gu: GameUpdateViewData) {
    ...
    // Packed per-player stats: [smallID, tilesOwned, gold, troops, oil] quints
    // for every player whose stats changed this tick (the per-tick churn that no
