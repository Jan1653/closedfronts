...
export class SoundManager {
  ...
  constructor(eventBus: EventBus, userSettings: UserSettings) {
    ...
    // Background music tracks shipped as proprietary assets in upstream
    // OpenFront and are not bundled with ClosedFronts. The playlist stays empty
    // until open-licensed tracks are added.
